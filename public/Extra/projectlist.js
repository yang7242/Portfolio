...
const AD = {
    ...
    description: "Active Directory is important because it provides centralized control over user access, security policies, and network resources. It is widely used in IT environments to manage large numbers of users and devices efficiently across domains. AD is essential for businesses, schools, and organizations that need secure, scalable, and organized network infrastructure. This project uses virtual machines to mimic handling the infrature and setting up in order to gain an understanding.",
